...
<html lang="ar" dir="rtl">
  ...
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/flatpickr/dist/themes/dark.css">
    ...
    <style>
      ...
      :root {
        --primary-color: #b48b1e !important;
      }
      ...
      <div class="navbar-wrapper">
        <div class="m-header">
          <a href="{{ route('dashboard') }}" class="b-brand text-primary">
            <img src="{{ asset('logo-primary-1.png') }}" class="logo" width="200" alt="">
          </a>
        </div>`
            ...
            <div class="card-body">
              <div class="d-flex align-items-center">
                <div class="flex-shrink-0">
                  <img alt="user-image" class="user-avtar wid-45 rounded-circle" src="{{ asset('https://ui-avatars.com/api/?name=' . implode('+', explode(' ', Auth::user()->name)) . '&background=b48b1e&color=fff') }}">
                </div>
